...
- (void) getVenuesWithCity:(NSString *) city {
    ...
    NSString *url = [NSString stringWithFormat:@"https://api.foursquare.com/v2/venues/explore?client_id=%@&client_secret=%@&v=20130815&near=%@&section=sights&venuePhotos=1&limit=50", FSclient_id, FSclient_secret_key, city];
...
//                NSLog(@"Venue: %@", venue);
            ...
            NSLog(@"%i POIs found for destination.", venues.count);
